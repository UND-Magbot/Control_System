...
export default function RemoteModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void; }){
    ...
    <div className="modalOverlay" onClick={onClose}>
      <div className="modalContent" onClick={(e) => e.stopPropagation()}>
        ...
        <div className='mapSection'>
            <img src="/images/map_sample.png" alt="Robot Map" className="mapImage" />
        </div>
        
        {/* 카메라 화면 (80%) */}
        <div className="mapCameraSection">
            {/* 실제 카메라 스트림을 여기에 */}
            <img src="/images/camera_sample.png" alt="Robot Camera" className="mapCameraImage"/>
        </div>
        ...
        <div className="controlSection">
          ...
          <button className="camera-remote-btn home" aria-label="home">
            <img src="/icon/main_w.png" alt="home" />
          </button>
