        ...
        <aside className={styles.sidebar}>
            <div>
                {menuItems.map((item, idx) => (
                    <Link key={idx} className={styles.menuItems} href={item.path} onMouseEnter={() => setHoveredIndex(idx)} onMouseLeave={() => setHoveredIndex(null)}>
            ...
            <div>
                ...
                <Link key={idx} href={item.path} className={styles.menuItems} onMouseEnter={() => setHoveredIndex(idx + 100)} onMouseLeave={() => setHoveredIndex(null)}>
                    <div className={`${item.icon}-icon`}>
